...
<h1 class="mt-6 mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-gray-700 text-center">Visualizar filmes</h1>
<p class="mb-10 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400 text-center">Aqui você pode visualizar todas as informacoes dos filmes</p>

<div class="my-10 mx-auto p-10 border-solid border-2  sm:rounded-md max-w-[80%] ">
	<form>
		<div class="relative z-0 w-full mb-6 group">
			<input disabled maxlength="255" type="text" name="floating_titulo" id="floating_titulo" class="block py-2.5 px-0 w-full text-sm dark:text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-900 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?php echo $dado['titulo']; ?>" required />
		...
		<div class="relative z-0 w-full mb-6 group">
			<input disabled maxlength="255" type="text" name="floating_idioma" id="floating_idioma" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-900 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?php echo $dado['idioma']; ?>" required />
			<label for="floating_idioma" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Idioma</label>
		</div>
		<div class="relative z-0 w-full mb-6 group">
			<input disabled maxlength="255" type="text" name="floating_categoria" id="floating_categoria" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-900 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?php echo $dado['categoria']; ?>" required />
