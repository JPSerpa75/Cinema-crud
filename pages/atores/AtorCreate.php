...
<h1 class="mt-6 mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-gray-700 text-center">Cadastrar novos atores</h1>
<p class="mb-10 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400 text-center">Aqui você pode inserir novos atores</p>

<div class="my-10 mx-auto p-10 border-solid border-2  sm:rounded-md max-w-[80%] ">
    <form action="../../actions/AtorAction.php" method="post">
