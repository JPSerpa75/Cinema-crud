...
<div class="flex justify-center items-center" style="width: 100%; height: 80%;">
	<div class="max-w-auto p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
		...
		<h5 class="text-center mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Tem certeza que deseja excluir o ator <?php echo $dado['nome'] . ' ' . $dado['sobrenome']; ?> ?</h5>
		...
		<div class="flex justify-center items-center mt-7 gap-5">
			...
			<a href="../../actions/AtorAction.php?id=<?php echo $dado['id_ator'] ?>" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">Excluir</a>
		</div>
	</div>
</div>
